...
AnimatedBuilder(
  ...
  builder: (context, child) {
    final sw = MediaQuery.of(context).size.width;
    final x = -160 + (((_cloudAnimation.value + 0.5) % 1.0) * (sw + 320));
...
AnimatedBuilder(
  ...
  builder: (context, child) {
    final sw = MediaQuery.of(context).size.width;
    final x = -180 + (((_cloudAnimation.value + 0.25) % 1.0) * (sw + 360));
...
AnimatedBuilder(
  animation: CurvedAnimation(parent: _cloudController, curve: Curves.linear),
  builder: (context, child) {
    final sw = MediaQuery.of(context).size.width;
    final x = -200 + (((_cloudAnimation.value + 0.1) % 1.0) * (sw + 400));
...
AnimatedBuilder(
  ...
  builder: (context, child) {
    final sw = MediaQuery.of(context).size.width;
    final x = -150 + (((_cloudAnimation.value + 0.7) % 1.0) * (sw + 300));
...
AnimatedBuilder(
  ...
  builder: (context, child) {
    final sw = MediaQuery.of(context).size.width;
    final x = -200 + (((_cloudAnimation.value + 0.4) % 1.0) * (sw + 400));
...
AnimatedBuilder(
  ...
  builder: (context, child) {
    final sw = MediaQuery.of(context).size.width;
    final x = -180 + (((_cloudAnimation.value + 0.85) % 1.0) * (sw + 360));
...
AnimatedBuilder(
  ...
  builder: (context, child) {
    final sw = MediaQuery.of(context).size.width;
    final x = -160 + (((_cloudAnimation.value + 0.6) % 1.0) * (sw + 320));
