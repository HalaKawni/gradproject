                    ...
                    child: Padding(
                      ...
                      child: ElevatedButton(
                        ...
                        child: Text(
                          ...
                          style: GoogleFonts.montserrat(fontSize: 16, fontWeight: FontWeight.w800, letterSpacing: 1.5),
                        ),
                      ),
                    ),
                  ),
            ...
            children: [
              Expanded(
                ...
                Text(
                  ...
                  style: GoogleFonts.nunito(
                      color: const Color(0xFF444444), fontSize: 17, height: 1.85),
                ),
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: const [
                      ...
                      TextSpan(
                        text: 'Kids from 5–14 years old can learn block-coding, text-coding, and Python all while playing! Kids as young as 5 can start programming and build their own games. Try it today!',
                      ),
                    ],
                  ),
                ),
              ...
              SizedBox(
                width: 200,
                child: Image.asset('assets/images/Teaching_to_code.png', fit: BoxFit.contain),
              ),
            ],
          ),
        ],
            ...
            child: SizedBox(
              ...
              child: Column(
                children: [
                  ...
                  Text('PARENTS',
                      style: GoogleFonts.amaticSc(
                          color: _navyText, fontSize: 44, fontWeight: FontWeight.w700)),
                  ...
                  Text(
                    ...
                    textAlign: TextAlign.center,
                    style: GoogleFonts.nunito(
                        color: _navyText.withValues(alpha: 0.85), fontSize: 14, height: 1.65),
                  ),
                    ...
                    '🐾  Educational Screen Time',
                        ...
                        child: Text(f,
                            style: GoogleFonts.montserrat(
                                color: _navyText, fontSize: 14, fontWeight: FontWeight.w700)),
                      )),
                  const SizedBox(height: 28),
                  ElevatedButton(
                    onPressed: () {},
            ...
            child: Column(
              children: [
                ClipRRect(
                  ...
                  child: Image.asset('assets/images/course1.jpg', height: 280, fit: BoxFit.cover),
                ),
                const SizedBox(height: 10),
                Text('A fun coding course for kids',
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text('CURRICULUM',
                    style: GoogleFonts.amaticSc(
                        color: _navyText, fontSize: 52, fontWeight: FontWeight.w700)),
                const SizedBox(height: 16),
                Text(
      ...
      child: Column(
        children: [
          Text(
            ...
            textAlign: TextAlign.center,
            style: GoogleFonts.amaticSc(color: Colors.white, fontSize: 44, fontWeight: FontWeight.w700),
          ),
          const SizedBox(height: 16),
          Text(
            ...
            textAlign: TextAlign.center,
            style: GoogleFonts.nunito(color: Colors.white70, fontSize: 14, height: 1.65),
          ),
      ...
      child: Column(
        children: [
          Text(
            ...
            textAlign: TextAlign.center,
            style: GoogleFonts.amaticSc(
                color: _navyText, fontSize: 40, fontWeight: FontWeight.w700, height: 1.2),
          ),
          const SizedBox(height: 48),
          Row(
      ...
      child: Column(
        children: [
          ...
          Text(title,
              textAlign: TextAlign.center,
              style: GoogleFonts.montserrat(
                  color: _navyText, fontSize: 12, fontWeight: FontWeight.w700, letterSpacing: 0.5)),
          const SizedBox(height: 8),
          Text(desc,
              textAlign: TextAlign.center,
              style: GoogleFonts.nunito(color: Colors.grey[600], fontSize: 13, height: 1.6)),
        ],
      ),
    );
  }
      ...
      child: Column(
        children: [
          Text(
            ...
            style: GoogleFonts.amaticSc(
                color: Colors.white, fontSize: 42, fontWeight: FontWeight.w700, letterSpacing: 2),
          ),
          const SizedBox(height: 40),
          Center(
            child: Image.asset('assets/images/codemonkey-devices-mobile.png',
                width: 700, fit: BoxFit.contain),
          ),
        ],
      ),
    );
      ...
      child: Column(
        children: [
          ...
          Text(
            ...
            textAlign: TextAlign.center,
            style: GoogleFonts.nunito(
                color: _navyText, fontSize: 15, height: 1.7, fontWeight: FontWeight.w600),
          ),
          const SizedBox(height: 40),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              _statBlob('LEVELS\nSOLVED', '570M+', const Color(0xFFF5E88A), const Color(0xFF7B6B10)),
              _statBlob('KIDS', '45M+', const Color(0xFFADD8E6), _darkTeal),
              _statBlob('PARENTS', '350K+', const Color(0xFFBFD9A0), const Color(0xFF3A6B20)),
            ],
          ),
        ],
      ),
    ...
    return Column(
      children: [
        Text(label,
            textAlign: TextAlign.center,
            style: GoogleFonts.montserrat(
                color: fg, fontSize: 11, fontWeight: FontWeight.w700, letterSpacing: 1)),
        const SizedBox(height: 10),
        Container(
          width: 140,
          height: 120,
          decoration: BoxDecoration(color: bg, borderRadius: BorderRadius.circular(64)),
          child: Center(child: Text(value, style: GoogleFonts.pacifico(color: fg, fontSize: 28))),
        ),
      ],
    );
  }
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          Column(
            children: [
              Text('All you need in one place',
                  style: GoogleFonts.amaticSc(
                      color: _navyText, fontSize: 46, fontWeight: FontWeight.w700)),
              const SizedBox(height: 48),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: GoogleFonts.nunito(
                              color: _navyText.withValues(alpha: 0.82), fontSize: 14, height: 1.7),
                        ),
                      ],
                    ),
                  ),
                  const SizedBox(width: 40),
                  Image.asset('assets/images/classroom-management-2.png',
              ...
              Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Image.asset('assets/images/standards-checklist1.png',
                      height: 220, fit: BoxFit.contain),
                  const SizedBox(width: 32),
                  Image.asset('assets/images/teacher_-page-2.png',
                      height: 220, fit: BoxFit.contain),
                  const SizedBox(width: 32),
                  Expanded(
                    child: Column(
          ...
          Row(
            children: [
              ...
              'footer.contact_us'.tr(),
                  ...
                  child: Text(l,
                      style: GoogleFonts.nunito(
                          color: Colors.white54, fontSize: 12, fontWeight: FontWeight.w700)),
                )).toList(),
          ),
        ],
      ),
...
class _TypewriterSectionState extends State<_TypewriterSection> {
  static const _words = ['GAMIFIED', 'FUN', 'INTERACTIVE', 'ENGAGING', 'EXCITING'];
  int _wordIdx = 0;
  int _charCount = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Text('TEACH KIDS COURSES THAT ARE ',
              style: GoogleFonts.amaticSc(
                  color: const Color(0xFF2D3560), fontSize: 36,
                  fontWeight: FontWeight.w700, letterSpacing: 1)),
          Text(display,
              style: GoogleFonts.amaticSc(
                  color: const Color(0xFF5BA033), fontSize: 36, fontWeight: FontWeight.w700)),
...
class _CloudWavePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path();
    path.addRect(Rect.fromLTWH(0, baseY + bumpH * 0.5, size.width, size.height - baseY - bumpH * 0.5));
...
class _CourseDropdownState extends State<_CourseDropdown> {
  ...
  List<String> get _courses => [
        'courses.all'.tr(), 'courses.code_jr'.tr(), 'courses.beaver'.tr(),
        'courses.dodo'.tr(), 'courses.adventure'.tr(), 'courses.game_builder'.tr(),
        'courses.banana'.tr(), 'courses.chatbots'.tr(), 'courses.digital'.tr(),
        'courses.data'.tr(), 'courses.ai'.tr(), 'courses.highschool'.tr(),
        'courses.monthly'.tr(),
      ];
                          ...
                          children: [
                            Text(course,
                                style: GoogleFonts.montserrat(
                                    ...
                                    color: const Color(0xFF1A3A6B), letterSpacing: 0.3)),
                            if (isHighSchool)
                              const Icon(Icons.arrow_forward_ios, size: 12, color: Color(0xFF1A3A6B)),
                          ],
                        ),
                      ),
                    );
  ...
  @override
  void dispose() { _hideDropdown(); super.dispose(); }

  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => _overlayEntry == null ? _showDropdown(context) : _hideDropdown(),
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          border: Border(
            bottom: BorderSide(
                color: _hovered ? const Color.fromARGB(255, 195, 158, 222) : Colors.transparent,
                width: 3),
          ),
        ),
        child: Row(
          ...
          children: [
            Text('nav.courses'.tr(),
                style: GoogleFonts.montserrat(
                    fontSize: 14,
                    color: _hovered ? const Color.fromARGB(255, 195, 158, 222) : Colors.white,
                    fontWeight: FontWeight.w500)),
            Icon(Icons.keyboard_arrow_down,
                color: _hovered ? const Color.fromARGB(255, 195, 158, 222) : Colors.white, size: 16),
          ],
        ),
      ),
    );
...
class _HoverButton extends StatefulWidget {
  ...
  final bool filled;
  const _HoverButton({required this.label, required this.onPressed, this.filled = false});
  @override
    ...
    return MouseRegion(
      ...
      child: PopupMenuButton<String>(
        ...
        onSelected: (value) {
          ...
          context.setLocale(value == '🇸🇦 AR' ? const Locale('ar') : const Locale('en'));
        },
        itemBuilder: (_) => [
          PopupMenuItem(
            value: '🇺🇸 EN',
            child: Text('🇺🇸 English',
                style: GoogleFonts.montserrat(color: const Color(0xFFE8D8B0), fontSize: 13, fontWeight: FontWeight.w500)),
          ),
          PopupMenuItem(
            value: '🇸🇦 AR',
            child: Text('🇸🇦 العربية',
                style: GoogleFonts.montserrat(color: const Color(0xFFE8D8B0), fontSize: 14, fontWeight: FontWeight.w500)),
          ),
        ],
        child: AnimatedContainer(
          duration: const Duration(milliseconds: 200),
            ...
            children: [
              Text(_selected,
                  style: GoogleFonts.montserrat(
                      ...
                      fontSize: 14, fontWeight: FontWeight.w500)),
              Icon(Icons.keyboard_arrow_down,
                  color: _hovered ? const Color(0xFF3A2A00) : const Color(0xFFE8D8B0), size: 16),
            ],
          ),
        ),
      ),
