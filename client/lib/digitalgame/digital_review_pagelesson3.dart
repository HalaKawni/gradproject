...
//  PAGE
// ===========================================================================
class DigitalReviewPageLesson3 extends StatefulWidget {
  final Map<String, dynamic> lesson;
  const DigitalReviewPageLesson3({super.key, required this.lesson});

  @override
  State<DigitalReviewPageLesson3> createState() => _DigitalReviewPageLesson3State();
}

class _DigitalReviewPageLesson3State extends State<DigitalReviewPageLesson3>
  ...
  void _initSentences() {
    _sentences = [
      _Sentence([
        _SentencePart.text("Cameron noticed that his friends are starting to play with old-school toys like yo-yos, Play-Do, and Slinkies. Maybe there's a "),
        _SentencePart.blank(_Blank(id: 'b1', answer: 'trend')),
        _SentencePart.text(" to play with retro toys right now."),
      ]),
      _Sentence([
        _SentencePart.text("The teacher, who was the "),
        _SentencePart.blank(_Blank(id: 'b2', answer: 'host')),
        _SentencePart.text(" of the "),
        _SentencePart.blank(_Blank(id: 'b3', answer: 'video')),
        _SentencePart.text(" conference asked the students to "),
        _SentencePart.blank(_Blank(id: 'b4', answer: 'mute')),
        _SentencePart.text(" their microphones while she is presenting."),
      ]),
      _Sentence([
        _SentencePart.text("Good virtual reality applications provide an "),
        _SentencePart.blank(_Blank(id: 'b5', answer: 'immersive')),
        _SentencePart.text(" experience. So many of your "),
        _SentencePart.blank(_Blank(id: 'b6', answer: 'senses')),
        _SentencePart.text(" are engaged that you feel like you are in another world."),
      ]),
    ];
  }
      ...
      child: Column(children: [
        ...
        _NextButton(
          ...
          onTap: _done ? () => Navigator.of(context).push(
            MaterialPageRoute(
             builder: (_) => DigitalQuizPageLesson3(lesson: widget.lesson),
